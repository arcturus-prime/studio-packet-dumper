...
static CRITICAL_SECTION g_receiveLock;
static StudioDumper::VFTable g_vftable;
static StudioDumper::MenuState g_menu;
...
void CleanupGraphics(GLFWwindow* window)
{
